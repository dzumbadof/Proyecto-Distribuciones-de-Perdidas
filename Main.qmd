...
Algunos otros hallazgos importantes aparte de la eliminación del impacto positivo de la elimnación de la tendencia, es que encontraron que la binomial negativa se ajusta mejor a las frecuencias, mientras que Log-Laplace se ajusta mejor a la severidad de los daños a la propiedad, y la Log-lognormal a los extravíos. Luego para las cópulas se encuentra que cópulas elípticas (Gaussiana y t-Student) se ajustan mejor que las arquimedianas (Clayton y Gumbel). 
