...
Las pérdidas se pueden modelar utilizando la base proveniente del departamente de seguridad nacional de Estados Unidos, quienes manejan la seguridad en més de 400 aeropuertos del paés a través del TSA (transportation security Administration). De esta manera, los datos seréan obtenidos directamente del aparato gobernamental de los Estados Unidos. Ademés, esta base ha sido en trabajos similares como los de \@flores y \@chen2020aggregate (ética). Segén \@flores, se puede encontrar las distribuciones marginales de cada tipo de reclamo utilizando MLE, luego se pueden incorporar en un modelo de cépulas multivariadas, y finalmente se pueden evaluar utilizando las medidas de riesgo como el VaR y el TVaR (lógica). La cantidad de personas que se ven afectadas por extravéos o daéos al equipaje durante el chequeo en los aeropuertos es significante y representan costos que deben ser previstos para mantener el buen funcionamiento de la empresa y para que se puedan hacer los pagos correspondientes a los afectados (emocional).
